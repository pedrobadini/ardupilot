...
public:
    ...
    void WriteQ_Setup_Target_Position(int32_t log_next_lat, int32_t log_next_lon, int32_t log_next_alt, int32_t log_origin_lat, int32_t log_origin_lng, int32_t log_origin_alt, int32_t log_poscontrol_taget_x, int32_t log_poscontrol_taget_y, int32_t log_poscontrol_taget_z, float log_diff_x, float log_diff_y, uint8_t log_enter_if);
