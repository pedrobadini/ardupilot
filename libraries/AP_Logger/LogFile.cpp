...
void AP_Logger::WriteQ_Setup_Target_Position(
    ...
    int32_t log_origin_lat,
    int32_t log_origin_lng,
    int32_t log_origin_alt,
    int32_t log_poscontrol_taget_x,
    int32_t log_poscontrol_taget_y,
    int32_t log_poscontrol_taget_z,
    float log_diff_x,
    float log_diff_y,
    uint8_t log_enter_if)
{
    struct log_QAUTO_12 pkt = {
        ...
        origin_lat : log_origin_lat,
        origin_lng : log_origin_lng,
        origin_alt : log_origin_alt,
        poscontrol_taget_x : log_poscontrol_taget_x,
        poscontrol_taget_y : log_poscontrol_taget_y,
        poscontrol_taget_z : log_poscontrol_taget_z,
        diff_x : log_diff_x,
        diff_y : log_diff_y,
